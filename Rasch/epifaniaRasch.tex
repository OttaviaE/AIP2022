...
\tikzset{type1/.style={circle, fill=blue},
	...
	info/.style = {rectangle, rounded corners, minimum width=7.5cm, minimum height=10cm, text centered, draw=white,  text width=5.5cm},
	stat/.style = {rectangle, rounded corners, minimum height=10cm, text width=10.5cm}
}
...
\begin{tikzpicture}
	\node (first) [stat] {\textbf{\textcolor{template}{Linearity of the scores}}};
 	\node (second) [stat, below of=first] {\textbf{\textcolor{template}{Comparison invariance}}};
 	 	\node (third) [stat, below of=second] {\textbf{\textcolor{template}{Local independence}}};
